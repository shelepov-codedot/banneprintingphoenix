...
if ((strpos($_SERVER['REQUEST_URI'], 'order-received') !== false && !empty($_GET['key']))):
    ...
    <div class="success-page container" >
        <img class="success-page_img"
             src="<?php echo get_template_directory_uri() ?>/assets/img/icons/success page.svg">
...
<?php
    ...
    $no_all_data_shipping_or_billing = false;
            ...
            <div class="checkout__paypal">
                ...
                <?php if (isset($fields['billing_email'])): ?>
                    <div class="checkout__wrap checkout__wrap-maildesktop">
                        <div class="checkout__field-wrap">
                            ...
                            if (isset($value) && !empty($value)) { ?> value="<?= $value ?>"<?php } else { $no_all_data_shipping_or_billing = true; } ?>
                ...
                <?php if (isset($fieldsShipping['shipping_address_2'])): ?>
                    <div class="checkout__field-wrap">
                        ...
                        if (isset($value) && !empty($value)) { ?> value="<?= $value ?>"<?php } $no_all_data_shipping_or_billing = true; ?>
                ...
                <input type="hidden" name="no_all_data_shipping_or_billing" value="<?= $no_all_data_shipping_or_billing; ?>">
            </div>
