...
class WC_Admin_Meta_Boxes {
	...
	public function add_meta_boxes() {
		...
		foreach ( wc_get_order_types( 'order-meta-boxes' ) as $type ) {
			...
			/* Translators: %s order type name. */
            add_meta_box( 'woocommerce-order-notes', sprintf( __( '%s notes', 'woocommerce' ), $order_type_object->labels->singular_name ), 'WC_Meta_Box_Order_Notes::output', $type, 'side', 'high' );
            add_meta_box( 'woocommerce-order-members-chat', sprintf( __( '%s members chat', 'woocommerce' ), $order_type_object->labels->singular_name ), 'WC_Meta_Box_Order_Members_Chat::output', $type, 'side', 'default' );
