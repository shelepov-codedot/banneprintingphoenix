...
class PushoverHandler extends \UpsFreeVendor\Monolog\Handler\SocketHandler
{
     ...
     */
    public function __construct($token, $users, $title = null, $level = \UpsFreeVendor\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $highPriorityLevel = \UpsFreeVendor\Monolog\Logger::CRITICAL, $emergencyLevel = \UpsFreeVendor\Monolog\Logger::EMERGENCY, $retry = 30, $expire = 25200)
    {
