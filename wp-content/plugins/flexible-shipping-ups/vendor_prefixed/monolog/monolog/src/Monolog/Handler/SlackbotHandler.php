 ...
 */
class SlackbotHandler extends \UpsFreeVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \UpsFreeVendor\Monolog\Logger::CRITICAL, $bubble = \true)
    {
