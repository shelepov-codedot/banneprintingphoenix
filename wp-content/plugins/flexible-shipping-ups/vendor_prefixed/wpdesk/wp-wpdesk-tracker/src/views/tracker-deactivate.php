...
<h2><?php 
echo \sprintf(\__('You are deactivating %s plugin.', 'flexible-shipping-ups'), $plugin_name);
?></h2>
...
<div class="wpdesk_tracker_deactivate">
	<div class="body">
		...
		<div class="panel active" data-panel-id="reasons">
			<h4><strong><?php 
\_e(' If you have a moment, please let us know why you are deactivating plugin (anonymous feedback):', 'flexible-shipping-ups');
?></strong></h4>
			<ul id="reasons-list">
                <li class="reason">
                    <label>
	            	<span>
                        ...
                        <span><?php 
\_e('The plugin suddenly stopped working', 'flexible-shipping-ups');
?></span>
                    </label>
                </li>
                <li class="reason">
	            	...
	            	<span>
                        ...
                        <span><?php 
\_e('The plugin broke my site', 'flexible-shipping-ups');
?></span>
                    </label>
                </li>
...
?>">
				...
				<li class="reason">
	            	...
	            	<span>
						...
						<span><?php 
\_e('I only needed the plugin for a short period', 'flexible-shipping-ups');
?></span>
					</label>
				</li>
				<li class="reason">
	            	...
	            	<span>
						...
						<span><?php 
\_e('I no longer need the plugin', 'flexible-shipping-ups');
?></span>
					</label>
				</li>
				<li class="reason">
	            	...
	            	<span>
						...
						<span><?php 
\_e('It\'s a temporary deactivation. I\'m just debugging an issue.', 'flexible-shipping-ups');
?></span>
					</label>
				</li>
				<li class="reason has-input">
	            	...
	            	<span>
						...
						<span><?php 
\_e('Other', 'flexible-shipping-ups');
?></span>
					</label>
					<div id="other" class="reason-input">
						<input type="text" name="other" placeholder="<?php 
\_e('Kindly tell us the reason so we can improve', 'flexible-shipping-ups');
?>">
					</div>
				</li>
			</ul>
