...
class FieldApiStatusAjax implements \UpsFreeVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
     ...
     */
    public function __construct(\UpsFreeVendor\WPDesk\AbstractShipping\ShippingService $shipping_service, \UpsFreeVendor\WPDesk\AbstractShipping\Settings\SettingsValues $settings, \Psr\Log\LoggerInterface $logger)
    {
