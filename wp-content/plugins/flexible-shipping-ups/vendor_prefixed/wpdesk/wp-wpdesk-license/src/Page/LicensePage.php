...
class LicensePage implements \UpsFreeVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    {
        \add_submenu_page('wpdesk-helper', \__('Subscriptions', 'flexible-shipping-ups'), \__('Subscriptions', 'flexible-shipping-ups'), 'manage_options', self::PAGE_SLUG, [$this, 'handle_render_wpdesk_licenses_page']);
    }
    /**
