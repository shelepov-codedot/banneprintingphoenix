...
class LicenseActivation implements \UpsFreeVendor\WPDesk\License\Page\Action
{
    ...
    {
        \add_settings_error('api_key_check_text', 'api_key_check_error', \__('Connection failed to the Subscription Key API server. Try again later.', 'flexible-shipping-ups'), 'error');
    }
    /**
    ...
    {
        \add_settings_error('activate_text', 'activate_msg', \__('Plugin activated. ', 'flexible-shipping-ups') . "{$activate_results['message']}.", 'updated');
    }
    /**
     * Activate license.
     *
