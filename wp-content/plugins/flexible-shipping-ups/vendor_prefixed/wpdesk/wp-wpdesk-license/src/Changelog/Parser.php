...
namespace UpsFreeVendor\WPDesk\License\Changelog;

use ArrayObject;
use UpsFreeVendor\WPDesk\License\Changelog\Parser\Line;
/**
 * Can parse changelog.
 *
...
class Parser
{
    ...
    private function get_lines()
    {
        ...
        return \array_map(function ($line) {
            return new \UpsFreeVendor\WPDesk\License\Changelog\Parser\Line($line);
