...
class HelperRemoveInfo
{
    ...
    public function show_deactivate_helper_notice()
    {
        ...
        new \UpsFreeVendor\WPDesk\Notice\Notice(\sprintf(\__('We recommend to <a href="%s">deactivate and remove</a> the "WP Desk Helper" plugin as it is no longer required by WP Desk plugins', 'flexible-shipping-ups'), $remove_url));
    }
    /**
    ...
    public function show_remove_helper_notice()
    {
        ...
        new \UpsFreeVendor\WPDesk\Notice\Notice(\sprintf(\__('We recommend to <a href="%s">remove</a> the "WP Desk Helper" plugin as it is no longer required by WP Desk plugins', 'flexible-shipping-ups'), $remove_url));
    }
}
