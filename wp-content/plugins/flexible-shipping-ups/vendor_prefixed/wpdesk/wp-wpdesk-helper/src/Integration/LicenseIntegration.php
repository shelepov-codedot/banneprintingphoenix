...
use UpsFreeVendor\WPDesk\License\Page\LicensePage;
 ...
 */
class LicenseIntegration implements \UpsFreeVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /** @var LicensePage */
    ...
    {
        $plugin_registry = new \UpsFreeVendor\WPDesk\License\InstalledPlugins();
        $this->license_page = new \UpsFreeVendor\WPDesk\License\Page\LicensePage($plugin_registry);
