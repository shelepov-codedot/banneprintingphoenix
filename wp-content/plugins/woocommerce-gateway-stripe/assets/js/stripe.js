...
jQuery( function( $ ) {
	...
	var wc_stripe_form = {
		...
		createElements: function() {
			...
			console.log(wc_stripe_params.inline_cc_form)
			if ( 'yes' === wc_stripe_params.inline_cc_form ) {
				...
				console.log(stripe_card, stripe_exp, stripe_cvc)
			 ...
			 */
			console.log(wc_stripe_params.is_checkout)
			if ( 'yes' === wc_stripe_params.is_checkout ) {
				// $( document.body ).on( 'updated_checkout', function() {
					// Don't re-mount if already mounted in DOM.
					console.log($( '#stripe-card-element' ).children().length)
		 ...
		 */
		init: function() {
			console.log(wc_stripe_params.is_change_payment_page, wc_stripe_params.is_pay_for_order_page)
			...
			// checkout page
			console.log($( 'div.checkout__step-tree' ).length)
			if ( $( 'div.checkout__step-tree' ).length ) {
				this.form = $('div.checkout__step-tree');
			}

			// $( 'div.checkout__step-tree' )
			// 	.on(
		...
		createSource: function() {
			...
			console.log(wc_stripe_form.isSepaChosen())
